...
class add_img(process):
    ...
    def slice_dice(self, img_page, src_name, show, eps):
        ...
        if first_page_of_set:
            start = 281 #894 #471 # 900 # 460 # 539 # 1014 # 982 # 1000 #1100 # 728 # 820 # 995
            end =  730 #1443 # 735 # 1470 # 750 # 908 # 1560 # 1526 # 1528 # 1705 # 1071 # 1370 # 1547
            bands= 3
            suffix='a'
        else:
            start = 235 #469 #271 # 540 #260 # 267 # 622 # 584 #730 # 802 # 400 # 577
            end = 511 #1020 #532 # 1070 # 590 # 636 # 1169 # 1126 # 1255 # 1318 # 960 # 1127
            bands= 4
            suffix='b'
