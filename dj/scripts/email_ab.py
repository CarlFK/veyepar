...
class email_ab(process):
    ...
    subject_template = "stub testing:{{ep.name|safe}}"
    body_template = "stub testing:{{ep.description|safe}}"
...
Reference: {{ep.slug}}
http://veyepar.nextdayvideo.com/main/E/{{ep.id}}/
"""
    py_name = "email_ab.py"
    ...
    def process_ep(self, ep):
        ...
        if emails: 
            ...
            subject = Template(self.subject_template).render(Context({'ep':ep}))
            context = { 'ep':ep, 'py_name':self.py_name, }
