...
* "True" means we plan on recording your talk and posting it online.
* "None" means it may get recorded and processed, but it will not be made public.
* "False" means you have requested not to be recoreded, however the data is available for review in case you change your mind.
...
%(conf_url)s
Except for odd word wrap.  If it bothers you, let us know how you would like it and we will try to accommodate. 

If everything looks good, you don't need to do anything. Good luck with your talk, and you will get another email when the video is posted.
