...
class email_title(process):
    ...
    def process_ep(self, ep):
        ...
        if emails: 
            tos = ep.emails.split(',')
            subject = "%s: Video metadata for your talk %s" % (
                    ep.show.name,ep.name)
...
Your talk is scheduled for %(start}s in the room called %(location)s. The conference organizers will give you instructions on where to check in before your talk.  
