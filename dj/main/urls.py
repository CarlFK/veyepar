...
urlpatterns = [
    ...
    url(r'veyepar.cfg$',
        veyepar_cfg,
        name='veyepar_cfg'),
    url(r'C/(?P<client_slug>[-\w]+)/S/(?P<show_slug>[-\w]+)/barf.xlsx',
        barf_var,
        name='barf_var'),
    ...
    url(r'mk_episode/(?P<show_id>\w+)/', mk_episode,
        name='mk_episode'),
    ...
    url(r'(?P<rfxml>\w+)\.pdf/(?P<show_id>\w+)/(?P<episode_id>\w+)/.*$',
        episode_pdfs, name='pdf'),

    url(r'(?P<rfxml>\w+)\.pdf/(?P<show_id>\w+)/.*$',
